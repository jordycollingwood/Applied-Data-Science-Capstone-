...
pd_launch_dict = pd.DataFrame(launch_dict)
...
data_falcon9 = pd_launch_dict.loc[pd_launch_dict['BoosterVersion']!='Falcon 1']
...
payload_mass_mean = data_falcon9['PayloadMass'].mean(axis=0)
